...
class Component extends HTMLElement {
    ...
    get allAction() {
        ...
        if (!_nuka9510_js_util__WEBPACK_IMPORTED_MODULE_0__.Util.empty(keys)) {
            this.el.querySelectorAll(`[data-sce-action~="${keys.join('"], [data-sce-action~="')}"]`)
                .forEach((...arg) => {
                if (!arg[0].hasAttribute('data-sce-event')) {
                    return;
                }
    ...
    constructor() {
        ...
        this.#root = _context_js__WEBPACK_IMPORTED_MODULE_1__["default"].getRoot(this) ?? document;
        this.querySelectorAll('script[data-sce-arg]')
            .forEach((...arg) => {
            try {
        ...
        _context_js__WEBPACK_IMPORTED_MODULE_1__["default"].popRoot(this);
    }
        ...
        for (const action in this.#action) {
            this.#action[action]
                ...
                if (Array.isArray(arg[0].event)) {
                    ...
                    this.el.addEventListener(arg[0].event, arg[0].listener, arg[0].option);
                }
            });
        }
        this.addEvent();
        ...
        for (const action in this.#action) {
            this.#action[action]
                ...
                if (Array.isArray(arg[0].event)) {
                    ...
                    this.el.removeEventListener(arg[0].event, arg[0].listener, arg[0].option);
                }
            });
        }
        this.removeEvent();
    ...
    #render() {
        ...
        node.querySelectorAll('*').forEach((...arg) => {
            if (customElements.get(arg[0].localName)) {
                _context_js__WEBPACK_IMPORTED_MODULE_1__["default"].setRoot(arg[0], this);
            }
        });
        this.el.innerHTML = '';
        this.#setCss();
    ...
    static #actionHandle(component, interceptor, callback, action, flag) {
        return async (ev) => {
            ...
            if (!_nuka9510_js_util__WEBPACK_IMPORTED_MODULE_0__.Util.empty(action)) {
                ...
                target = ev.target.closest(`[data-sce-action~="${action}"]`);
                if (_nuka9510_js_util__WEBPACK_IMPORTED_MODULE_0__.Util.empty(target)) {
                    return;
                }
                if ((flag ?? false) &&
                    !(target.getAttribute('data-sce-event') ?? '')
                        .split(' ')
                        .includes(ev.type)) {
                    return;
                }
...
class State {
    ...
    get(arg) {
        if (arg == undefined) {
            return _nuka9510_js_util__WEBPACK_IMPORTED_MODULE_0__.Util.copy(this.#state ?? null);
        }
        else {
            return _nuka9510_js_util__WEBPACK_IMPORTED_MODULE_0__.Util.copy(this.#state[arg] ?? null);
        }
    }
}
...
/* harmony export */   Interceptor: () => (/* reexport safe */ _interceptor_js__WEBPACK_IMPORTED_MODULE_1__["default"]),
/* harmony export */   Plugin: () => (/* reexport safe */ _plugin_js__WEBPACK_IMPORTED_MODULE_2__["default"]),
/* harmony export */   Register: () => (/* reexport safe */ _register_js__WEBPACK_IMPORTED_MODULE_3__["default"])
/* harmony export */ });
/* harmony import */ var _component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./component.js */ "./dist/component.js");
/* harmony import */ var _interceptor_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./interceptor.js */ "./dist/interceptor.js");
/* harmony import */ var _plugin_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./plugin.js */ "./dist/plugin.js");
/* harmony import */ var _register_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./register.js */ "./dist/register.js");
...
var __webpack_exports__Interceptor = __webpack_exports__.Interceptor
var __webpack_exports__Plugin = __webpack_exports__.Plugin
var __webpack_exports__Register = __webpack_exports__.Register
export { __webpack_exports__Component as Component, __webpack_exports__Interceptor as Interceptor, __webpack_exports__Plugin as Plugin, __webpack_exports__Register as Register };
