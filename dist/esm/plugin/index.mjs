...
class UtilAction {
    constructor(component) {
        ...
        _plugin_js__WEBPACK_IMPORTED_MODULE_1__["default"].append({
    ...
    async #numberOnly(ev, target, component) {
        ...
        if (_nuka9510_js_util__WEBPACK_IMPORTED_MODULE_0__.Util.isNumber(min) ||
            ...
            if (flag) {
                let _value;
                if (type == 'C') {
                    _value = _nuka9510_js_util__WEBPACK_IMPORTED_MODULE_0__.Util.numberFormat(num, parseInt(target.dataset['sceDecimal'] ?? '0'));
                }
                else {
                    _value = `${num}`;
                }
...
var __webpack_exports__UtilAction = __webpack_exports__.UtilAction
export { __webpack_exports__UtilAction as UtilAction };
